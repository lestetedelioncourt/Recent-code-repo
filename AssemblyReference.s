...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 19 18:24:31 2023
...
testing_set = torchvision.datasets.FashionMNIST('./data',
                                                download=True,
                                                train=False,
                                                transform=transform)
...
for epoch in range(1):
    ...
    for i, data in enumerate(training_loader, 0):
        ...
        if i % 1000 == 999:
            ...
            net.train(False)
            for j, vdata in enumerate(testing_loader, 0):
            ...
            avg_vloss = running_vloss / len(testing_loader)
...
def select_n_random(data, labels, n=100):
    ...
    perm = torch.randperm(len(data)) #randomly permute
